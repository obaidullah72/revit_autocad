    ...
    try:
        ...
        try:
            ...
            log_lines = [
                ...
                f"  - As rooms: {stats['room_types']['ROOM']}",
                f"  - As halls/corridors: {stats['room_types']['HALL']}",
                f"  - As open areas: {stats['room_types']['OPEN_AREA']}",
                f"  - Unclassified: {stats['room_types']['UNCLASSIFIED']}",
